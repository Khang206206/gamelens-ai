...
TypeScript 5.9, and Tailwind CSS 4. It presents the catalog and Stage 3 request-scoped
recommendations plus the in-progress Stage 4 explicit-consent saved-personalization flow.
